...
class FeedbackForm extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->greeting('Форма зворотнього зв\'язку - COTA CRS' . request()->getHost())
            ->subject("Форма зворотнього зв\'язку - COTA CRS" . request()->getHost())
